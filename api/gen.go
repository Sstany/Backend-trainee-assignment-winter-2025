...
//go:generate oapi-codegen -o ../pkg/client/types.go -generate types -package client schema.yaml
//go:generate oapi-codegen -o ../pkg/client/http_client.go -generate client -package client schema.yaml
